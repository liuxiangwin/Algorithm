...
* @author obullxl
*/
public final class ThreadPoolComplex {
    private static Logger logger = Logger.getLogger(ThreadPoolComplex.class);
    ...
    /* 单例 */
    private static ThreadPoolComplex instance = ThreadPoolComplex.getInstance();
    ...
    private ThreadPoolComplex(int pool_worker_num) {
    ...
    public static synchronized ThreadPoolComplex getInstance() {
        if (instance == null)
            return new ThreadPoolComplex();
        return instance;
    }
    /**
    * 增加新的任务
