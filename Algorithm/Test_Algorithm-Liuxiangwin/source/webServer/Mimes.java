 ...
 *@since   7 june 2002
 * 
 * Mimes.java - Mimes supply the mime type according to the file extension
 *
...
/** 
 * class Mimes Belong to the webServer Package
 */
package webServer;
import java.io.*;
...
public class Mimes { 
	...
	private int FILE_EXTENS_POS; //contain the file extension position in the file name
	private String FILE_EXTENSION; //contain the file extension 
