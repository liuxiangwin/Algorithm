...
public class BinaryTree<E> {
	...
	/**
	 * A one-time constructor, for constructing empty trees. Space efficiencies
	 * are possible if empty trees are reused.
	 *
	...
	/**
	 * Constructs a tree node with two children. Value of the node and subtrees
	 * are provided by the user.
	 *
	 ...
	 * Parent of the right subtree is
	 * updated consistently. Existing subtree is detached
	 *
	...
	{
		BinaryTree binaryTree = new BinaryTree<Integer>(1, new BinaryTree(3), new BinaryTree(2));
		
		//BinaryTree binaryTree = new BinaryTree<E>(value, left, right)
