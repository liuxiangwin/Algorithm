...
public class TestWorkMulti implements Runnable {
	public boolean running = false;

	public TestWorkMulti() {
	...
	public void run() {
		...
		try {
			...
			// As user Bernd points out in the comments section below, you
			// should
	...
	public static void main(String[] args) throws InterruptedException {
		List<TestWorkMulti> workers = new ArrayList<TestWorkMulti>();
		...
		System.out.println("This whole process took: " + difference / 1000
				+ " seconds.");
	}
