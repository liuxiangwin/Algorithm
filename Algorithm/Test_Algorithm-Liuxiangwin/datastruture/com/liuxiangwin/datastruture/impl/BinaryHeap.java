...
public class BinaryHeap
{
	...
	public Comparable [ ] array; // The heap array
	/**
...
/*11*/      array[ hole ] = tmp;
	...
	public static void main(String[] args) throws Exception {
		...
		binaryHeap.insert(new Integer(1));
		binaryHeap.insert(new Integer(2));
		binaryHeap.insert(new Integer(3));
		binaryHeap.insert(new Integer(4));
		binaryHeap.insert(new Integer(5));
		binaryHeap.insert(new Integer(6));
		binaryHeap.insert(new Integer(7));
		binaryHeap.insert(new Integer(8));
		binaryHeap.insert(new Integer(9));
