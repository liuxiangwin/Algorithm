package com.quiz.arrangement.web.handler;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { com.quiz.arrangement.exception.ResourceNotFoundException.class })
	protected ResponseEntity<Object> handleResourceNotFoundException(com.quiz.arrangement.exception.ResourceNotFoundException ex,
			WebRequest request) {
		logger.error(ex.getMessage(), ex);
		com.quiz.arrangement.model.ErrorResponse errorResponse = new com.quiz.arrangement.model.ErrorResponse();
